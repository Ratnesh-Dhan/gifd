          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-12 items-start">
            ...
            <div className="rounded-xl p-6 ">
              <div className="flex items-center gap-4 mb-5">
                {/* This is test */}
                <div className=" bg-black rounded-3xl w-180 h-110 transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-[0px_0px_20px_rgba(0,0,0,0.50)]">
                  ...
                  <div className="px-10 pt-5 font-bold">
                    <h3 className="text-lg mt-4 text-amber-400">Founder</h3>
            ...
            <div className="rounded-xl p-6 ">
              <div className="flex items-center gap-4 mb-5 justify-end">
                ...
                <Image
                  ...
                  className="rounded-[50] object-cover border-2 border-amber-500 bg-white shadow hover:shadow-xl transition duration-300"
                /> */}
                <div className=" bg-black rounded-3xl w-190 h-110 transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-[0px_0px_20px_rgba(0,0,0,0.50)]">
                  <div className="relative w-full h-[70%] rounded-t-3xl overflow-hidden ">
                    <Image
                      src="/images/founder.jpg"
                      alt="Founder Image"
                  ...
                  <div className="px-10 pt-5 font-bold">
                    <h3 className="text-lg mt-4 text-amber-400">Co Founder</h3>
