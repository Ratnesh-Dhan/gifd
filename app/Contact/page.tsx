    ...
    <div className="min-h-screen">
      ...
      <div className="flex justify-center mt-20">
        ...
        <div className="ml-10 mb-10">
          ...
          <h3 className="text-4xl my-4">Needs Help ? Let&apos;s Get<br /> in Touch</h3>
          <span>Get In Touch with us for more details.</span>
          <div className="mt-20 flex"><Image src="/icons/location.png" alt="locatoin" width={50} height={50} />
          <div className="ml-4">
            <h3 className="text-xl">Address:</h3>
            <span>2/4 , Birenu trade centre, pennar road , sakchi, 831001 1</span>
          </div>
          </div>
          <div className="mt-8 flex"><Image src="/icons/call.png" alt="phone" width={45} height={45} />
           <div className="ml-4">
            <h3 className="text-xl">
            Call Us: +91-810 261 1868
            </h3>
            <span>Office Time : 10:00 to 07:00 on Weekdays</span></div></div>
          <div className="mt-8 flex"><Image src="/icons/gmail.png" alt="gmail" width={45} height={45} />
          <div className="ml-4">
